    ...
    <body>
        <div id="container">
            ...
            <div id="main-page">
                ...
                <br>
<%  try{
        String[][] purchases = SOAPClientSAAJ.getArrayFromSOAPRespond((String)session.getAttribute("t"),"get_sales_purchase", "x", (String)session.getAttribute("un"), "mode", "purchases", null,null,null,null,null,null,null,null,null,null,null,null);
