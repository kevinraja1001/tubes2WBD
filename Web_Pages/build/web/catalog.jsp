        ...
        <div id="container">
            <div id="logo">
                ...
                <div id="navigation">
                    ...
                    <form action="catalog.jsp" method="GET" id="search-area">
                        ...
                        <div>
                            by
                            <input type="radio" name="typex" value="p" checked> Product
                            <input type="radio" name="typex" value="s" > Store
                        </div>
                    </form>

                    
<%  if(request.getParameter("typex") == null){
        out.println("<div id=\"teks-pencarian\">");
        out.println("                <hr />");
        out.println("            </div>");
        try{
            ...
            for(int i=0; i<katalog.length; i++){
                ...
                out.println("            <div class=\"item-all\">");
    ...
    else if(request.getParameter("typex").equalsIgnoreCase("p")){
        out.println("<div id=\"teks-pencarian\">");
        out.println("<b>"+request.getParameter("keyword")+" by "+"product</b>");
        out.println("                <hr />");
        out.println("            </div>");
        try{
            String[][] katalog = SOAPClientSAAJ.getArrayFromSOAPRespond(null,"search", "keyword",request.getParameter("keyword"),"by","product",null,null,null,null,null,null,null,null,null,null,null,null);
            for(int i=0; i<katalog.length; i++){
    ...
    else if(request.getParameter("typex").equalsIgnoreCase("s")){
        out.println("<div id=\"teks-pencarian\">");
        out.println("<b>"+request.getParameter("keyword")+" by "+"store</b>");
        out.println("                <hr />");
        out.println("            </div>");
        try{
            String[][] katalog = SOAPClientSAAJ.getArrayFromSOAPRespond(null,"search", "keyword",request.getParameter("keyword"),"by","store",null,null,null,null,null,null,null,null,null,null,null,null);
            for(int i=0; i<katalog.length; i++){
...
%>
                ...
                <div id="section-confirm">
                    ...
                    <hr />
                    <form action="../misc/do-buy.php" method="post" id="buy-product">
