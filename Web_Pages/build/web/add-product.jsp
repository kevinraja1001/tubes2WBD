...
<%  out.println("                  <div>Hi, "+(String)session.getAttribute("fn")+"!</div>");%>
                ...
                <hr />
                <form method="post" enctype="multipart/form-data" id="formap" action="../misc/do-add-product.php?id='.$USER_DATA['id'].'">
                    ...
                    <div class="data-input">
                        ...
                        <textarea rows="3" id="desc" name="desc" form="add-product"></textarea>
                    </div>
                    <div class="data-input">
                        <div>
                            Price (IDR)
