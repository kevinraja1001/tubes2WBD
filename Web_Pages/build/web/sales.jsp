    ...
    <body>
        <div id="container">
            ...
            <div id="main-page">
                ...
                <hr>
<%  try{
        String[][] sales = SOAPClientSAAJ.getArrayFromSOAPRespond((String)session.getAttribute("t"),"get_sales_purchase", "x", (String)session.getAttribute("un"), "mode", "sales", null,null,null,null,null,null,null,null,null,null,null,null);
