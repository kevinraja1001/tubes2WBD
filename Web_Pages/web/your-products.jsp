        ...
        <div id="container">
            ...
            <div id="main-page">
                ...
                <div id="section-your_products">
                    ...
                    <div class="item">
<%  try{
        String[][] katalog = SOAPClientSAAJ.getArrayFromSOAPRespond((String)session.getAttribute("t"),"product_of","penjual",(String)session.getAttribute("un"),null,null,null,null,null,null,null,null,null,null,null,null,null,null);
